...
- Ensured production image layers never contain declarations or source maps, with an OCI-layer regression check rather than relying only on the final container filesystem.
